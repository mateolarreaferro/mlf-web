...
export const PARAMETERS = [
  ...
  { id: 'visual.fog', label: 'view distance', group: 'picture', min: 18, max: 65, step: 1, default: 30, unit: ' m' },
  { id: 'visual.sparkle', label: 'light scatter', group: 'picture', min: 0, max: 2, step: 0.05, default: 1, unit: '×' },
  { id: 'motion.speed', label: 'motion speed', group: 'movement', min: 0, max: 2, step: 0.05, default: 0.8, unit: '×' },
  { id: 'motion.breathing', label: 'breathing intensity', group: 'movement', min: 0, max: 1, step: 0.05, default: 0.6, unit: '×' },
  { id: 'motion.current', label: 'current strength', group: 'movement', min: 0, max: 2, step: 0.05, default: 1, unit: '×' },
